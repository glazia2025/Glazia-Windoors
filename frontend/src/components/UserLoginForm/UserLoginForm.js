    ...
    <MDBContainer fluid className="mdb-container">
      ...
      >
        ...
        >
          ...
          <p style={{ color: "hsl(217, 10%, 50.8%)" }}>
            Glazia is a tech-enabled aggregator revolutionizing the facade and
            fenestration industry. We simplify raw material procurement by
            bringing Aluminium Profiles, Hardware, and Accessories onto a single
            platform—ensuring cost efficiency, faster deliveries, and superior
            quality for fabricators and businesses.
          </p>

          <h5>Why Glazia?</h5>
          <ul className="why-glazia">
            <li>
              ✔ Comprehensive Product Range – Order Aluminium Profiles with your
              preferred finish (Powder Coating, Anodizing, PVDF Coating), along
              with hardware, accessories, and glass—all in one place.
            </li>
            <li>
              ✔ Reduced Costs, Faster Delivery – Our streamlined supply chain
              eliminates inefficiencies, saving you time and money.
            </li>
            <li>
              ✔ Tech-Driven Convenience – A digital-first approach enables
              seamless order tracking, transparent pricing, and hassle-free
              procurement.
            </li>
            <li>
              ✔ Guaranteed Quality – We partner with top manufacturers to
              provide standardized, high-performance materials that meet global
              benchmarks.
            </li>
          </ul>
          ...
          <p>
            🚀 Glazia – Your Gateway to Faster, Smarter, and Cost-Effective
            Facade Solutions
          </p>
        </MDBCol>
