...
export const ORDER_STATUS_LONG_LABELS = {
    [ORDER_STATUS.LOADING]: "Loading...",
    [ORDER_STATUS.FIRST_APPROVAL_PENDING]: "Proof submitted. Waiting for approval.",
    [ORDER_STATUS.SECOND_PAYMENT_PENDING]: "Final payment pending but not due today.",
    [ORDER_STATUS.SECOND_PAYMENT_OVERDUE]: "Final payment overdue. Submit proof.",
    [ORDER_STATUS.SECOND_APPROVAL_PENDING]: "Final proof submitted. Waiting for approval.",
    [ORDER_STATUS.COMPLETED]: "Completed.",
}
